...
public class ImSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ImPackage.APP_PROBES: {
			AppProbes appProbes = (AppProbes) theEObject;
			T result = caseAppProbes(appProbes);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>App Probes</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>App Probes</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAppProbes(AppProbes object) {
		return null;
	}
