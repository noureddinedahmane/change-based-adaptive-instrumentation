...
import tools.vitruv.applications.javaim.modelrefinement.Java2ImInternalActionChangeTransformationImp;
...
public class Java2ImMethodBodyChangeTransformation extends AbstractChangePropagationSpecification {
  ...
  public Java2ImMethodBodyChangeTransformation(final Code2SeffFactory code2SEFFfactory) {
  ...
  public void propagateChange(final TransactionalChange change, final CorrespondenceModel correspondenceModel, final ResourceAccess resourceAccess) {
    ...
    if (_doesHandleChange) {
      ...
      this.executeJava2ImTransformation(correspondenceModel, this.getUserInteractor(), compositeChange, false);
    } else {
      boolean _isOnlyInternalActionBodyChange = this.isOnlyInternalActionBodyChange(change, correspondenceModel);
      if (_isOnlyInternalActionBodyChange) {
        final CompositeTransactionalChange compositeChange_1 = ((CompositeTransactionalChange) change);
        this.executeJava2ImTransformation(correspondenceModel, this.getUserInteractor(), compositeChange_1, true);
      }
    }
  }
   ...
   */
  public boolean isOnlyInternalActionBodyChange(final TransactionalChange change, final CorrespondenceModel correspondenceModel) {
    return false;
  }
  ...
  public void executeJava2ImTransformation(final CorrespondenceModel correspondenceModel, final UserInteractor userInteracting, final CompositeTransactionalChange compositeChange, final boolean onlyInternalActionsUpdate) {
    ...
    if (onlyInternalActionsUpdate) {
      final Java2ImInternalActionChangeTransformationImp java2Im = new Java2ImInternalActionChangeTransformationImp(this.code2SeffFactory, newMethod, correspondenceModel);
